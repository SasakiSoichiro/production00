...
// レールクラス
//*********************
class CTutorialRail :public CObject
{
public:
	CTutorialRail();	// コンストラクタ
	~CTutorialRail();	// デストラクタ
	static CTutorialRail* Create(D3DXVECTOR3 point0, D3DXVECTOR3 point1, D3DXVECTOR3 point2, D3DXVECTOR3 point3, int nType);// インスタンス生成
