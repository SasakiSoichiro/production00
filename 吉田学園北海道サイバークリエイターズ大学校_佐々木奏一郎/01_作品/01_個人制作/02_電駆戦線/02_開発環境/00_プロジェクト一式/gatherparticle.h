//*****************************************
//
// 集まるパーティクル処理 [gatherarticle.h]
// Author:Sasaki Soichiro
//
//*****************************************
#ifndef _GATHERPARTICLE_H_ // このマクロ定義がされていなかったら
#define _GATHERPARTICLE_H_ // 二重インクルード防止のマクロ定義
...
// 集まるパーティクルクラス
//**************************
class CGatherParticle :public CObject
{
public:
	CGatherParticle(int nPriority = 3);	// コンストラクタ
	~CGatherParticle();					// デストラクタ
	static CGatherParticle* Create(D3DXVECTOR3 pos, int radius, D3DXVECTOR2 size, int nAmount, int nLife, int nTime, D3DXCOLOR col);// インスタンス生成
