...
HRESULT CTimer::Init(D3DXVECTOR3 pos)
{
	for (int nCntTime = 0; nCntTime < 2; nCntTime++)
	{
		...
		m_apMin[nCntTime]->SetCol(D3DXCOLOR(0.8f, 0.8f,0.0f,1.0f));
