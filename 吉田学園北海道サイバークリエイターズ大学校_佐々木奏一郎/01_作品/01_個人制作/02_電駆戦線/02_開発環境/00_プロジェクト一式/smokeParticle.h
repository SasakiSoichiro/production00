//*****************************************
//
// 煙パーティクル処理 [smokeParticle.h]
// Author:Sasaki Soichiro
//
//*****************************************
#ifndef _SMOKEPARTICLE_H_ // このマクロ定義がされていなかったら
#define _SMOKEPARTICLE_H_ // 二重インクルード防止のマクロ定義
...
// パーティクルクラス
//********************
class CSmokeParticle :public CObject
{
public:
	CSmokeParticle(int nPriority = 3);	// コンストラクタ
	~CSmokeParticle();					// デストラクタ
	static CSmokeParticle* Create(D3DXVECTOR3 pos, int radius, D3DXVECTOR2 size, int nAmount, int nLife, int nTime, D3DXCOLOR col);// インスタンス生成
